                ...
                echo '<form method="post" id="fields_form">';
                    ...
                    echo '<div class="smaller-side">';
                        ...
                        echo '<div class="inactive-fields zone" ondrop="dropField(this, event)" ondragenter="return false" ondragover="return false">';
                            echo '<span class="field" draggable="true" id="name" data-id="name" ondragstart="dragField(this, event)">Name</span>';
                            echo '<span class="field" draggable="true" id="title" data-id="title" ondragstart="dragField(this, event)">Title</span>';
                            echo '<span class="field" draggable="true" id="location" data-id="location" ondragstart="dragField(this, event)">Location</span>';
                            echo '<span class="field" draggable="true" id="bio" data-id="bio" ondragstart="dragField(this, event)">Bio</span>';
                            echo '<span class="field" draggable="true" id="views data-id="views" ondragstart="dragField(this, event)">Views</span>';
                            echo '<span class="field" draggable="true" id="rank" data-id="rank" ondragstart="dragField(this, event)">Rank</span>';
                            echo '<span class="field" draggable="true" id="badges" data-id="badges" ondragstart="dragField(this, event)">Badges</span>';
                            echo '<span class="field" draggable="true" id="followers" data-id="followers" ondragstart="dragField(this, event)">Followers</span>';
                            echo '<span class="field" draggable="true" id="following" data-id="following" ondragstart="dragField(this, event)">Following</span>';
                            echo '<span class="field" draggable="true" id="skills" data-id="skills" ondragstart="dragField(this, event)">Skills</span>';
                            echo '<span class="field" draggable="true" id="languages" data-id="languages" ondragstart="dragField(this, event)">Languages</span>';
                            echo '<span class="field" draggable="true" id="environments" data-id="environments" ondragstart="dragField(this, event)">Environments</span>';
                            echo '<span class="field" draggable="true" id="frameworks" data-id="frameworks" ondragstart="dragField(this, event)">Frameworks</span>';
                            echo '<span class="field" draggable="true" id="tools" data-id="tools" ondragstart="dragField(this, event)">Tools</span>';
                            echo '<span class="field" draggable="true" id="interests" data-id="interests" ondragstart="dragField(this, event)">Interests</span>';
                            echo '<span class="field" draggable="true" id="traits" data-id="traits" ondragstart="dragField(this, event)">Traits</span>';
                            echo '<span class="field" draggable="true" id="areas" data-id="areas" ondragstart="dragField(this, event)">Areas</span>';
                            echo '<span class="field" draggable="true" id="badges" data-id="badges" ondragstart="dragField(this, event)">Badges</span>';
                        echo '</div>';
                    echo '</div>';
                    echo '</div>';
